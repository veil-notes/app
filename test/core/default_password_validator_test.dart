...
void main() {
  ...
  group('DefaultPasswordValidator', () {
    test('rejects blank passwords', () {
      ...
      expect(result.message, 'Password is required.');
    });
    ...
    test('rejects passwords shorter than 8 characters', () {
      ...
      expect(result.isValid, isFalse);
      expect(result.message, 'Password must have at least 8 characters.');
    });
    ...
    test('rejects passwords without letters', () {
      ...
      expect(result.isValid, isFalse);
      expect(result.message, 'Password must contain at least one letter.');
    });
    ...
    test('rejects passwords without numbers', () {
      ...
      expect(result.isValid, isFalse);
      expect(result.message, 'Password must contain at least one number.');
    });
