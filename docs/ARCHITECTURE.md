...
This document describes the current architecture, security model, runtime flow, and operational commands of Veil.
...
The user-facing project overview is in the root [README](../README.md).

Community and contribution policies are documented in:
